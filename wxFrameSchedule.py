...
import wxScheduler, wxFrameEvent, wxSchedule, wxSchedulerPaint, wxReportScheduler
...
ID_PREVIEW = wxSchedulerPaint.wxSCHEDULER_PREVIEW
...
class wxFrameSchedule(wx.Frame):
    ...
    def OnMB_PrintPreview(self):
        ...
        rpt1    = wxReportScheduler.wxReportScheduler(format, day, self.schedule.GetSchedules())
        rpt2    = wxReportScheduler.wxReportScheduler(format, day, self.schedule.GetSchedules())
